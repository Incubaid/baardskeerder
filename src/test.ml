...
let serialize_deserialize_1 () =
  ...
  OUnit.assert_equal ~printer:string_of_entry (Leaf leaf) leaf';
  OUnit.assert_equal ~printer:string_of_entry (Index index) index';
  OUnit.assert_equal ~printer:string_of_entry (Value value) value'
